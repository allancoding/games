...
<script type="text/javascript">
    EJS_player = '#game';
    EJS_gameUrl = 'MK64.n64.zip'; // Url to Game rom
    EJS_gameID = 14; // ID in your website, required for netplay.
    EJS_core = 'n64';
    EJS_gameName = "Mario Kart 64!";
</script>
...
.backg{
    background-image: url("MK64.jpg") !important;

...
<script type="text/javascript">
    EJS_player = '#game';
    EJS_gameUrl = 'SF64.n64.zip'; // Url to Game rom
    EJS_gameID = 11; // ID in your website, required for netplay.
    EJS_core = 'n64';
    EJS_mouse = false; // SNES Mouse
    EJS_multitap = false; // SNES Multitap
    EJS_gameName = "Star Fox 64!";
</script>
...
.backg{
    background-image: url("SF64.jpg") !important;

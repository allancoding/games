...
<script type="text/javascript">
    EJS_player = '#game';
    EJS_gameUrl = "SMB3.nes.zip"; // Url to Game rom
    EJS_gameID = 9; // ID in your website, required for netplay.
    EJS_core = 'nes';
    EJS_mouse = false; // SNES Mouse
    EJS_multitap = false; // SNES Multitap
    EJS_gameName = "Super Mario Bros 3!";
</script>
...
.backg{
    background-image: url("SMB3.jpg") !important;

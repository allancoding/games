...
(function () {
    ...
    const product = urlParams.get('r');
    if (product) {
        gravities.push(new GravityPoint(Math.floor(Math.random() * window.innerWidth - 30) + 30, Math.floor(Math.random() * window.innerHeight - 30) + 30, 10, {
            particles: particles,
            gravities: gravities
        }));
    }
    document.onkeyup = function () {
        ...
        if (e.key == 'g') {
            ...
            window.location.href = "https://irondistrict.instructure.com/login/ldap";
        } else if (e.key == 'h') {
            window.location.href = "https://chs.irondistrict.org/";
        } else if (e.key == 'l') {
            window.location.href = "https://launch.irondistrict.org/";
        } else if (e.key == 'm') {
            for (var i = gravities.length - 1; i >= 0; i--) {
                if (gravities[i].isMouseOver) {
                    gravities[i].startDrag(mouse);
            ...
            for (var i = 0; i <= 1; i++) {
                gravities.push(new GravityPoint(window.innerWidth / 2, window.innerHeight / 2, 20, {
                    particles: particles,
                    gravities: gravities
                }));
            }
    ...
    // GUI
    // gui = new dat.GUI();
    // gui.add(control, 'particleNum', 0, 800).step(1).name('Particle Num').onChange(function() {

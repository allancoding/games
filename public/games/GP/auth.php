...
<title>Get Person! - <?php echo STARTER_GREETING; ?></title>	<style>
...
<form class="pure-form pure-form-stacked" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
    <fieldset>

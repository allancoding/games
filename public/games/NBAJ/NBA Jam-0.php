...
<script type="text/javascript">
    EJS_player = '#game';
    EJS_gameUrl = "NBAJ.sfc.zip"; // Url to Game rom
    EJS_gameID = 12; // ID in your website, required for netplay.
    EJS_core = 'snes';
    EJS_mouse = false; // SNES Mouse
    EJS_multitap = false; // SNES Multitap
    EJS_gameName = 'NBA Jam!';
</script>
...
.backg{
    background-image: url("NBAJ.jpg") !important;

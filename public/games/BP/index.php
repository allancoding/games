...
<link href="styles.css?04a292114971b0e856ce" rel="stylesheet"></head>
<body>
<main>
    <section class="welcome">
        ...
        <form id="game">
            ...
            <div class="game-modes">
                ...
                <div>
                    <label title="Fight between teams."><input type="radio" name="mode" value="teams"> Teams</label> <a href="?swarm&mode=teams" style="text-decoration: none; color: inherit; font-size: 12px">swarm</a>
                </div>
                <div>
                ...
                <div>
                    <label title="Be only one who survived."><input type="radio" name="mode" value="only-one"> Only one</label>
                </div>
            </div>
            <div class="action">
...
<script type="text/javascript" src="bundle.js?04a292114971b0e856ce"></script>
</html>
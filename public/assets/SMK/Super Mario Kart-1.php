...
<script type="text/javascript">
    EJS_player = '#game';
    EJS_gameUrl = "SMK.smc.zip"; // Url to Game rom
    EJS_gameID = 8; // ID in your website, required for netplay.
    EJS_core = 'snes';
    EJS_mouse = false; // SNES Mouse
    EJS_multitap = false; // SNES Multitap
    EJS_gameName = "Super Mario Kart!";
</script>
...
.backg{
    background-image: url("SMK.png") !important;

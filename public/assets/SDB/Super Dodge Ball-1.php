...
<script type="text/javascript">
    EJS_player = '#game';
    EJS_gameUrl = "SDB.nes.zip"; // Url to Game rom
    EJS_gameID = 7; // ID in your website, required for netplay.
    EJS_core = 'nes';
    EJS_mouse = false; // SNES Mouse
    EJS_multitap = false; // SNES Multitap
    EJS_gameName = 'Super Dodge Ball!';
</script>
...
.backg{
    background-image: url("SDB.png") !important;
